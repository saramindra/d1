...
namespace Oxide.Plugins
{
    ...
    public class DragDropDemo : RustPlugin
    {
        ...
        private void StartAnimeStandalone(BasePlayer player)
        {
            ...
            // タイマー始動
            var state = new AnimeState { Angle = 0f, Mode = AnimeMode.Standalone };
            state.Tick = timer.Repeat(TickInterval, 0, () =>
            {
                ...
                state.Angle = (state.Angle + DegPerSecond * TickInterval) % 360f;
        ...
        private void StartAnimeInsideDemo(BasePlayer player)
        {
            ...
            var state = new AnimeState { Angle = 0f, Mode = AnimeMode.InsideDemo };
            state.Tick = timer.Repeat(TickInterval, 0, () =>
            {
